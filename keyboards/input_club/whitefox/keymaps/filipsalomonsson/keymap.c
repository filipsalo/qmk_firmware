...
tap_dance_action_t tap_dance_actions[] = {
    // Tap once for Shift, twice for Hyper
    [TD_SFT_HYPER] = ACTION_TAP_DANCE_DOUBLE(KC_LSFT, KC_HYPR),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_65_ansi_blocker_split_bs(
        ...
        KC_LGUI, LGUI_T(KC_A), LSFT_T(KC_S), LALT_T(KC_D), LCTL_T(KC_F), KC_G, KC_H,         RCTL_T(KC_J), RALT_T(KC_K), RSFT_T(KC_L), RGUI_T(KC_SCLN), KC_QUOT,     KC_ENT,               KC_PGUP,
        TD(0),               KC_Z,         KC_X,         KC_C,         KC_V, KC_B,         KC_N,         KC_M,         KC_COMM,      KC_DOT,          KC_SLSH, KC_RSFT,     KC_UP,       KC_PGDN,
